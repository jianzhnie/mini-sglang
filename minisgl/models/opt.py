...
class OPTAttention(nn.Module):
    ...
    def __init__(self, hidden_size: int, num_heads: int, bias: bool = True) -> None:
        ...
        self.q_proj = ColumnParallelLinear(hidden_size, num_heads * self.head_dim, bias=bias)
        self.k_proj = ColumnParallelLinear(hidden_size, num_heads * self.head_dim, bias=bias)
        self.v_proj = ColumnParallelLinear(hidden_size, num_heads * self.head_dim, bias=bias)
        self.out_proj = RowParallelLinear(num_heads * self.head_dim, hidden_size, bias=bias)
...
class OPTModel(nn.Module):
    ...
    def __init__(self, config) -> None:
        ...
        self.layers = nn.ModuleList([
            OPTDecoderLayer(config.hidden_size, config.num_attention_heads, config.intermediate_size)
